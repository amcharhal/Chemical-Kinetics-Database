...
class TestScrapping(unittest.TestCase):
    ...
    def test_search(self):
        self.assertEqual(self.automated_search.search(), [self.react_name])
    ...
    def test_send_key_match(self):
        ...
        self.assertEqual(len(reactions_web_element), 179)
        self.assertEqual(int(record_number), 438)
    ...
    def test_html_navigate(self):
        ...
        soup = BeautifulSoup(read, 'html.parser')
        results = self.automated_search.htm_navigate(soup)
